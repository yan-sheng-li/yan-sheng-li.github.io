module.exports = {
    ...
    themeConfig: {
      nav: [
        // { text: '🏠首页', link: '/' },
        { text: '🎧呼叫作者，一对一', link: 'https://qm.qq.com/cgi-bin/qm/qr?k=NZUoWMzd3PQLWwxRGMiBNYEnVkEdNq__&jump_from=webapi&authKey=kgAofDqUzgwMCSX+UQQwxf837zMeWFGGmo4iIcbgkklW2pdfmVOlxPWAK6sMYMaC' },
